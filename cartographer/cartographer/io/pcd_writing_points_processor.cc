...
void WriteBinaryPcdHeader(const bool has_color, const int64 num_points,
  ...
  stream << "# generated by Juefx\n"
         << "VERSION .7\n"
         << "FIELDS x y z _ intensity" << color_header_field << "\n"
         << "SIZE 4 4 4 1 4" << color_header_size << "\n"
         << "TYPE F F F U F" << color_header_type << "\n"
         << "COUNT 1 1 1 4 1" << color_header_count << "\n"
