...
proto::PoseGraph::Constraint::Tag ToProto(
  ...
  switch (tag) {
    ...
    case PoseGraph::Constraint::Tag::INTER_SUBMAP_LONG:
      return proto::PoseGraph::Constraint::INTER_SUBMAP_LONG;
  }
...
PoseGraph::Constraint::Tag FromProto(
  ...
  switch (proto) {
    ...
    case proto::PoseGraph::Constraint::INTER_SUBMAP_LONG:
      return PoseGraph::Constraint::Tag::INTER_SUBMAP_LONG;
