...
proto::ConstraintBuilderOptions CreateConstraintBuilderOptions(
  ...
  options.set_submap_node_size(
      parameter_dictionary->GetInt("submap_node_size"));
  options.set_long_distance_submap_count(
      parameter_dictionary->GetInt("long_distance_submap_count"));
  options.set_long_distance_min_score(
      parameter_dictionary->GetDouble("long_distance_min_score"));
